    ...
    bearish: {
        ...
        steps: [
            ...
            { 
                ...
                desc: "The drop creates a massive Bearish FVG between 103.5 and 108.5. Price retraces upwards at 11:15, filling the gap. This is the institutional entry point to go short.",
                chk: 4,
                shapes: [
                    {type: 'rect', x0: '10:30', x1: '11:45', y0: 103.5, y1: 108.5, fillcolor: 'rgba(239, 68, 68, 0.2)', line: {width: 0}},
                    {type: 'line', x0: '10:30', x1: '11:45', y0: 101.5, y1: 101.5, line: {color: 'red', width: 2}}
                ],
                annotations: [{x: '11:00', y: 106.0, text: 'Fair Value Gap (Entry)', showarrow: false, font: {color: 'red'}}]
            },
            { 
                idx: 12, 
