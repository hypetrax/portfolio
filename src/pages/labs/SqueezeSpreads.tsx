...
export const SqueezeSpreads = memo(() => {
    ...
    const chartOptions = {
        ...
        scales: {
            y: {
                ...
                title: { display: true, text: 'Price ($)', color: '#4a5568' },
                beginAtZero: false,
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'row', height: '100vh', overflow: 'hidden', backgroundColor: 'var(--bg-color)', color: 'var(--text-main)', fontFamily: 'var(--font-sans)' }} className="squeeze-playbook flex-col md:flex-row">
            <SEO 
            ...
            <style dangerouslySetInnerHTML={{ __html: `
                ...
                .squeeze-playbook .md\\:flex-row { flex-direction: row; }
                .squeeze-playbook .md\\:grid-cols-2 { grid-template-columns: repeat(2, minmax(0, 1fr)); }
                .squeeze-playbook .md\\:grid-cols-3 { grid-template-columns: repeat(3, minmax(0, 1fr)); }
                @media (max-width: 767px) {
                    ...
                    .squeeze-main > .fade-in {
                        padding: 28px 18px !important;
                    }
                    .squeeze-playbook .flex-col {
                        flex-direction: column !important;
                    }
                    .squeeze-playbook .grid-cols-1 {
                        grid-template-columns: 1fr !important;
                    }
                    .squeeze-playbook .grid-cols-2 {
            ...
            {/* Sidebar Nav */}
            <nav style={{ width: '256px', backgroundColor: 'var(--surface)', borderRight: '1px solid var(--border)', display: 'flex', flexDirection: 'column', flexShrink: 0, zIndex: 10 }} className="squeeze-sidebar w-full md:w-64">
            ...
            {/* Main Content */}
            <main style={{ flex: 1, overflowY: 'auto', backgroundColor: 'var(--bg-color)', position: 'relative' }} className="squeeze-main">
